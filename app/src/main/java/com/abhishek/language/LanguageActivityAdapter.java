...
public class LanguageActivityAdapter extends FirebaseRecyclerAdapter<DataModel, LanguageActivityAdapter.myviewholder> {
    private Context context;
    String chidId;
    DatabaseReference dbReference;

    public LanguageActivityAdapter(Context context, @NonNull FirebaseRecyclerOptions<DataModel> options, DatabaseReference dbReference) {
        super(options);
